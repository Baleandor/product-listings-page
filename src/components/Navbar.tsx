    ...
    return (
        <div className="p-2 flex items-center justify-center sticky z-10">
            ...
            <div className="p-1 mr-auto">
                <Link to={ROUTE_PATH.BUGGIEZ} className="p-2 mr-1 border rounded-xl border-red-600">Buggiez</Link>
                <Link to={ROUTE_PATH.GUNZ} className="p-2 mr-1 border rounded-xl border-red-600">Gunz</Link>
            </div>
        </div>
    )
}